...
(DatabaseService as jest.MockedClass<typeof DatabaseService>).prototype.getReadingByUuid = mockGetReadingByUuid;
(DatabaseService as jest.MockedClass<typeof DatabaseService>).prototype.updateReading = mockUpdateReading;
