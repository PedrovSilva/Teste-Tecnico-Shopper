...
describe("GET /customers/:customer_code/list", () => {
    ...
    it("should return measures for a customer", async () => {
        ...
        mockDbService.prototype.getMeasuresByCustomerCode.mockResolvedValue(measures);
    ...
    it("should return 500 on server error", async () => {
        ...
        mockDbService.prototype.getMeasuresByCustomerCode.mockRejectedValue(new Error("Database error"));
